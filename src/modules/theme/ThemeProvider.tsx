...
import {IThemeContext, ThemeType, ThemeTypes} from './types/ThemeTypes.ts';
...
export const ThemeProvider: React.FC<IProps> = ({ children }) => {
  ...
  const changeTheme = (newTheme: ThemeTypes) => {
    console.log(`Changing theme to: ${newTheme}`); // Логирование
    ...
    console.log(`Current theme state: ${newTheme}`); // Логирование
  };
